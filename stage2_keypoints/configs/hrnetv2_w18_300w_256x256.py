# HRNet-W18 face landmark on 300W (68 points), derived from MMPose official config.
# Training budget tuned for practical runtime on single GPU.

_base_ = [
    "/usr/local/lib/python3.10/dist-packages/mmpose/.mim/configs/_base_/default_runtime.py"
]
...
default_hooks = dict(
    checkpoint=dict(type='CheckpointHook', interval=1, save_best='NME', rule='less', max_keep_ckpts=3),
)
...
data_mode = 'topdown'
data_root = 'stage2_keypoints/data/300w/'
