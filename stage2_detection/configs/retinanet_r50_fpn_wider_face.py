# RetinaNet R50-FPN on WIDER FACE (single class: face)
# MMDetection 3.x config

default_scope = "mmdet"

custom_imports = dict(
    imports=["mmdet.datasets"], allow_failed_imports=False
)
...
data_root = "stage2_detection/data/wider_face/"
